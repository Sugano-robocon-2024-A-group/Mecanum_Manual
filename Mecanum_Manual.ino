...
//const int encoderA[4] = {34, 35, 36, 39}; // エンコーダA相ピン
//const int encoderB[4] = {18, 19, 21, 17}; // エンコーダB相ピン
const int motor_pwm[2] = {13, 4}; // PWM出力ピン
const int motor_dir1[2] = {27, 32}; // 方向ピン1
const int motor_dir2[2] = {14, 33}; // 方向ピン2
const int encoderA[2] = {22, 18}; // エンコーダA相ピン
const int encoderB[2] = {23, 19}; // エンコーダB相ピン
...
void init_pwm_setup()
{
  ...
  for (int i = 0; i < 4; i++)
  {
    ledcAttach(motor_pwm[i], 5000, 8); // PWM出力ピン、周波数5000Hz、8ビット解像度
  }
}
